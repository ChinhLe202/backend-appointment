...
let initRoutes = (app) => {
    ...
    router.get('/api/clinic/get-list-clinics', clinic.getListClincs)
    router.get('/api/clinic/get-top5-clinics',  clinic.getTop5Clincs)
    router.get('/api/specialization/get-list-specialization',  clinic.getListSpecializations)
    router.get('/api/patient/get-list-booking/:keySearch',  clinic.getListBookingPatients)
